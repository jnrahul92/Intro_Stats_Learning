...
svmfit = svm(y~., data = dat, subset = train, kernel = "radial", cost = 1e5, gamma = 1)
...
svmfit.opt = svm(y~., data = dat, subset = train, kernel = "radial",
...
svm.flex = svm(y~., data = dat, subset = train, kernel = "radial",
